 ...
 */
export declare function createMachine<S = {}, C = {}>(
  initial: keyof S,
 ...
 */
export declare function state(...args: (Transition | Immediate)[]): MachineState
 ...
 */
export declare function transition<C, E>(
  event: string,
  state: string,
 ...
 */
export declare function immediate<C, E>(
  state: string,
  ...args: (Reducer<C, E> | Guard<C, E> | Action<C, E>)[]
): Transition
 ...
 */
export declare function guard<C, E>(guardFunction?: GuardFunction<C, E>): Guard<C, E>
 ...
 */
export declare function reduce<C, E>(reduceFunction?: ReduceFunction<C, E>): Reducer<C, E>
 ...
 */
export declare function action<C, E>(actionFunction?: ActionFunction<C, E>): Action<C, E>
 ...
 */
export declare function interpret<M extends Machine, E>(
  machine: M,
 ...
 * @param args - Any argument needs to be of type Transition or Immediate.
 */
export declare function invoke<C, T, E extends {} = any>(fn: (ctx: C, e?: E) => Promise<T>, ...args: (Transition | Immediate)[]): MachineState
 ...
 * @param args - Any argument needs to be of type Transition or Immediate.
 */
export declare function invoke<C, E extends {} = any, M extends Machine>(fn: (ctx: C, e?: E) => M, ...args: (Transition | Immediate)[]): MachineState
 ...
 * @param args - Any argument needs to be of type Transition or Immediate.
 */
export declare function invoke<M extends Machine>(machine: M, ...args: (Transition | Immediate)[]): MachineState

/* General Types */

export declare type ContextFunction<T> = (initialContext: T) => T

export declare type GuardFunction<C, E> = (context: C, event: E) => boolean

export declare type ActionFunction<C, E> = (context: C, event: E) => unknown

export declare type ReduceFunction<C, E> = (context: C, event: E) => C

export declare type InterpretOnChangeFunction<T extends Machine> = (
  service: Service<T>
) => void

export declare type SendEvent = string | { type: string; [key: string]: any }
export declare type SendFunction<T = SendEvent> = (event: T) => void
 ...
 */
export declare type OnEnterFunction<M extends Machine> =
  <C = M['state']>(machine: M, to: string, state: C, prevState: C, event?: SendEvent) => void

export declare type Machine<S = {}, C = {}, K = string> = {
  context: C
  current: K
  states: S
  state: {
...
export declare type Action<C, E> = {
  fn: ActionFunction<C, E>
}

export declare type Reducer<C, E> = {
  fn: ReduceFunction<C, E>
}

export declare type Guard<C, E> = {
...
export declare interface Service<M extends Machine> {
  child?: Service<M>
  machine: M
  context: M['context']
...
export declare type Immediate = Transition