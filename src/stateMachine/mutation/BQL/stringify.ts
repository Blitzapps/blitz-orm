...
import { BQLMutationBlock, BormConfig, EnrichedBQLMutationBlock, EnrichedBormEntity, EnrichedBormRelation, EnrichedBormSchema, EnrichedLinkField, LinkedFieldWithThing } from "../../../types";
...
*/
const tObject = (schema: EnrichedBormSchema, tree: Record<string, any> | string | (Record<string, any> | string)[], $thing?: string) => {
...
const tField = (schema: EnrichedBormSchema, tree: Record<string, any>, key: string, thing: EnrichedBormEntity | EnrichedBormRelation) => {
...
const getRoleThing = (
  role: { name: string, playedBy?: LinkedFieldWithThing[] },
