...
import type { BormConfig, BormSchema, EnrichedBormEntity, EnrichedBormRelation, EnrichedBormSchema, ParsedBQLQuery, PipelineOperation, RawBQLQuery } from '../../../types';
...
export const parseTQLQuery = async (props: {
  ...
  enrichedBqlQuery: ParsedBQLQuery;
  schema: EnrichedBormSchema;
  config: BormConfig;
  rawTqlRes: any;
  isBatched: boolean;
}): Promise<TypeDbResponse> => {
	const { enrichedBqlQuery, rawBqlRequest, schema, config, rawTqlRes, isBatched } = props;
