...
import type { BormConfig, EnrichedBormEntity, EnrichedBormRelation, EnrichedBormSchema, EnrichedBQLQuery, RawBQLQuery } from '../../../types';
import { QueryPath } from '../../../types/symbols';
import { TypeDbResponse } from '../../../pipeline/pipeline';
...
const realParse = (res: any, rawBqlRequest: RawBQLQuery, schema: EnrichedBormSchema, config: BormConfig): TypeDbResponse => {
  return res.map((item) => {
...
const parseDataFields = (dataFields: any, currentSchema: EnrichedBormEntity | EnrichedBormRelation, config: BormConfig) => {
