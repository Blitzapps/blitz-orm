...
# Start the container
docker run --detach --rm --pull always -v $(pwd)/tests:/tests -p 8000:8000 --name $CONTAINER_NAME surrealdb/surrealdb:v2.0.0-alpha.6 start --allow-all -u $USER -p $PASSWORD --bind 0.0.0.0:8000
