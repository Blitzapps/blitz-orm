...
# Create the schema
docker exec -it $CONTAINER_NAME ./surreal import -u tester -p tester --namespace multi_db_test --database test --endpoint http://localhost:8000  ./tests/multidb/mocks/schema.surql
# Insert data
