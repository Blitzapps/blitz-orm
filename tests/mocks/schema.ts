...
export const schema: BormSchema = {
  entities: {
        ...
        pre: [
          ...
          },
          {
            actions: [
              {
                type: 'transform',
                fn: ({ $op, $id }, _b, _c, { spaces: dbSpaces }) => {
        ...
        pre: [
          ...
          },
          {
            actions: [
              {
                type: 'transform',
                fn: ({ $op, $id }, _b, _c, { dataFields: dbDataFields }) => {
        ...
        pre: [
          {
            actions: [
              {
                type: 'transform',
                fn: ({ $op }, _b, _c, { cascadeRelations: dbCascadeRelations }) => {
    ...
    Company: {
      ...
      dataFields: [
        { ...id },
        { path: 'name', contentType: 'TEXT', validations: { required: true } },
        {
          path: 'industry',
          contentType: 'TEXT',
          validations: {
            enum: ['Tech', 'Finance', 'Healthcare', 'Retail', 'Manufacturing'] as string[],
          },
        },
      ],
      linkFields: [
